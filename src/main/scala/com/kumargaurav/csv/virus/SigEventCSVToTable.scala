...
object SigEventCSVToTable extends App {
    ...
    val schemaPath = if(args.length>0 && args(0) != "" ) args(0) else "gs://it-slr-historical-data-qa/signature.txt"
    ...
    finaldf.show(100)
    finaldf.write.mode(SaveMode.Overwrite).parquet("gs://itd-aia-de/temp/virusdb/sig_event/")
}
