...
object JsonToCsv extends App {
  ...
  val tableName = "bridgecrew.bc_resources"
  ...
  val jsonPath = "/Users/gkumargaur/workspace/java/office/pub-sub-to-bq-dataflow/datasets/target/bridgecrew_landing/tables/bc_resources.json"
